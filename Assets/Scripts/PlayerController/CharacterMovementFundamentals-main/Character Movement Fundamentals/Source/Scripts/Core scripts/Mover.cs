...
namespace CMF
{
	...
	public class Mover : MonoBehaviour {
		...
		// Method to get the currently attached collider
		...
		public void CheckForGround()
		{
			...
			if(currentLayer != this.gameObject.layer)
			{
				...
				Debug.LogWarning("Current layer for CheckForGround does not match this.gameobject.layer! Recalculating SensorLayerMask");
				RecalculateSensorLayerMask();
			}
